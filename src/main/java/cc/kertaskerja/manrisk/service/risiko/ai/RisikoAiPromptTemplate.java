...
enum RisikoAiPromptTemplate {
    ...
    PENGENDALIAN_YANG_SUDAH_ADA(
            "pengendalian-yang-sudah-ada",
            List.of("scope"),
            List.of("pernyataan_risiko"),
            Set.of("pernyataan_risiko")
    ),
    ...
    REALISASI_TINDAK_PENGENDALIAN(
            ...
            List.of("scope"),
            List.of("rencana_tindak_pengendalian"),
            Set.of("rencana_tindak_pengendalian")
    );
    ...
    RisikoAiPromptTemplate(String type, List<String> contextFields, List<String> inputFields, Set<String> requiredInput) {
        this.type = type;
    ...
    static RisikoAiPromptTemplate fromType(String type) {
        return Arrays.stream(values())
                .filter(template -> template.type.equals(type))
                .findFirst()
    ...
    String resourcePath() {
        return "prompts/risiko/" + VERSION + "/" + type + ".md";
    }
