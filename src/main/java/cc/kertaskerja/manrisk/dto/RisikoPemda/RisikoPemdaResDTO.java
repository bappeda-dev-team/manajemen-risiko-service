...
public class RisikoPemdaResDTO {
    ...
    @JsonProperty("sasaran_pemda")
    private String sasaranPemda;

    @JsonProperty("periode")
    private String periode;

    @JsonProperty("indikators")
    private List<RisikoOpdResDTO.Indikator> indikators;

    @JsonProperty("risiko")
    private List<RisikoOpdResDTO.RisikoItem> risiko;
    ...
    public static class Indikator {
        ...
        private String definisiOperasional;

        @JsonProperty("tahun_aktif")
        private Integer tahunAktif;

        @JsonProperty("targets")
        private List<RisikoOpdResDTO.Target> targets;
    }
